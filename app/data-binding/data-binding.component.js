...
var DataBindingComponent = (function () {
    function DataBindingComponent() {
        ...
        this.urlImg = 'http://www.planwallpaper.com/static/images/desktop-year-of-the-tiger-images-wallpaper.jpg';
        this.widthImage = '200px';
        this.msgType = ["-", "Success", "Info", "Warning", "Error"];
        this.msgClass = ["", "alert-success", "alert-info", "alert-warning", "alert-danger"];
    }
